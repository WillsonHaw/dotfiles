...

{
  ...
  config = lib.mkIf config.noodles.desktops.hyprland.enable {
    home-manager.users.slumpy =
      { config, ... }:
      {
        ...
        # home.file."${config.xdg.configHome}/hypr/card".source = config.lib.file.mkOutOfStoreSymlink "/dev/dri/by-path/pci-0000:09:00.0-card";
